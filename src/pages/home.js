...
<li className="nav-item">
<a className="page-scroll" href="http://localhost:9000/testimonials">Testimonial</a>
</li>
<li className="nav-item">
...
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 350 112.35"><defs></defs><title>bottom-part1</title><g id="bottom-part"><g id="Group_747" data-name="Group 747"><path id="Path_294" data-name="Path 294" style={{fill:'#2bdbdc',isolation:'isolate',opacity:'0.1'}} d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z" transform="translate(0 0)"></path><path id="Path_297" data-name="Path 297" style={{fill:'#2bdbdc',isolation:'isolate',opacity:'0.2'}} d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z" transform="translate(0 0)"></path><path id="Path_296" data-name="Path 296" style={{fill:'#2bdbdc',isolation:'isolate',opacity:'0.4'}} d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z" transform="translate(0 0)"></path><path id="Path_295" data-name="Path 295" style={{fill:'#2bdbdc',isolation:'isolate',opacity:'0.6'}} d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z" transform="translate(0 0)"></path></g></g></svg>
</div>
</div> 
 </div>
<div className="col-lg-4 col-md-7 col-sm-9">
...
<div className="buttom-shape">
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 350 112.35"><defs></defs><title>bottom-part1</title><g id="bottom-part"><g id="Group_747" data-name="Group 747"><path id="Path_294" data-name="Path 294" style={{fill:'#0067f4',isolation:'isolate',opacity:'0.1'}} d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z" transform="translate(0 0)"></path><path id="Path_297" data-name="Path 297"  style={{fill:'#0067f4',isolation:'isolate',opacity:'0.2'}} d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z" transform="translate(0 0)"></path><path id="Path_296" data-name="Path 296"  style={{fill:'#0067f4',isolation:'isolate',opacity:'0.4'}} d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z" transform="translate(0 0)"></path><path id="Path_295" data-name="Path 295"  style={{fill:'#0067f4',isolation:'isolate',opacity:'0.6'}} d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z" transform="translate(0 0)"></path></g></g></svg>
</div>
</div> 
</div>
<div className="col-lg-4 col-md-7 col-sm-9">
...
<div className="buttom-shape">
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 350 112.35"><defs></defs><title>bottom-part1</title><g id="bottom-part"><g id="Group_747" data-name="Group 747"><path id="Path_294" data-name="Path 294" style={{fill:'#4da422',isolation:'isolate',opacity:'0.1'}} d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z" transform="translate(0 0)"></path><path id="Path_297" data-name="Path 297" style={{fill:'#4da422',isolation:'isolate',opacity:'0.2'}} d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z" transform="translate(0 0)"></path><path id="Path_296" data-name="Path 296" style={{fill:'#4da422',isolation:'isolate',opacity:'0.4'}} d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z" transform="translate(0 0)"></path><path id="Path_295" data-name="Path 295" style={{fill:'#4da422',isolation:'isolate',opacity:'0.6'}} d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z" transform="translate(0 0)"></path></g></g></svg>
</div>
</div> 
</div>
</div> 
